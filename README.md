...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/divine4)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/divine4
```

A live public deployment of this template is available at [https://divine4.templates.workers.dev](https://divine4.templates.workers.dev)
